...
public class HomeFragment extends BaseMvpFragment<HomePresenter> implements IHomeView, OnChannelListener {
    ...
    public List<Channel> mSelectedDatas = new ArrayList<>(); // 选中的频道
    public List<Channel> mUnSelectedDatas = new ArrayList<>(); // 未选中的频道
